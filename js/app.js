(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__slider", ".blends__slider", ".gallery__slider")) {
            ...
            new swiper_core_Swiper(".blends__slider", {
                ...
                speed: 800,
                scrollbar: {
                    el: ".blends__slider-scrollbar",
                    draggable: true
                },
                navigation: {
                    prevEl: ".blends__slider-button-prev",
                    nextEl: ".blends__slider-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
